...
/**
 * Shared header component used by both DutyCard and DutyDetailModal.
 * Ensures consistent visual identity (Squircle, Source Tag, Fonts, Countdown).
 */
@Composable
fun DutyCardHeader(
    duty: Duty,
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            val timeText = if (duty.isAllDay) {
                if (isTask) "All Day Task" else "All Day Event"
            } else if (isTask) {
...
// Private helper to keep logic encapsulated
